  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine - Streamlining Your Dining Experience. Reserve Your Table and Let Our Team Handle the Rest."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine - Streamlining Your Dining Experience. Reserve Your Table and Let Our Team Handle the Rest.`}
            </Text>
            <Box
